    ...
    for epoch in range(max_epoch):
        ...
        for user_id in users_for_train:
            local_weights[user_id], local_concept_mask[user_id], local_results[user_id], local_explanation_f[user_id] \
                = local_train(user_id, epochs=50, train_loader=train_loader_users[user_id],
                              ...
                              topk_explanations=50, verbose=False, logic_generation_threshold=0.8)
