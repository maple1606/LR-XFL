...
if noise_type == 'global':
    ...
    x_noise, y_noise = add_noise('mnist', noise_type='feature', noise_ratio=0.8, noise_degree=0.1)
    ...
    x_noise, y_noise = add_noise('mnist', noise_type='label', noise_ratio=1, noise_degree=0.8)
    dataset_noise = TensorDataset(x_noise, y_noise)
...
for seed in range(n_seeds):
    ...
    for epoch in range(max_epoch):
        ...
        users_aggregation_weight = {u: 0 for u in range(10)}
