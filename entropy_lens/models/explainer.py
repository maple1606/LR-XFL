...
class Explainer(BaseExplainer):
    ...
    def explain_class(self, train_dataloaders: DataLoader, val_dataloaders: DataLoader, test_dataloaders: DataLoader,
        ...
        for target_class in target_classes:
            class_explanation, explanation_raw, explanation_connector = explain_class(self.model.cpu(),
                                                               x_train, y_train_1h,
                                                               x_val, y_val_1h,
            ...
            if class_explanation:
                ...
                # accuracy to show the consistency between the logic rule results and the ground truth labels
                ...
                # fidelity to show the consistency between the logic rule results and the model predicted results (y_pred)
                ...
                explanation_accuracy, explanation_fidelity, explanation_complexity, explanation_connector = 0, 0, 0, None
            results = {
                'target_class': target_class,
                ...
                'explanation_connector': explanation_connector
            }
            if verbose:
